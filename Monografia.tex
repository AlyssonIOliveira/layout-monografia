...
\data{Março de 2020}	% Adicionando a data
...
\orientador{Prof.~Dr.~Nicolino Trompieri Neto} % adicionando orientador
...
\begin{fichacatalografica}
	...
	\begin{center}					% Minipage Centralizado
		\fbox{\begin{minipage}[c][8cm]{13.5cm}		% Largura
				...
				2. Palavra-chave2.
				3. Palavra-chave2.
				I. Prof.~Dr.~Nicolino Trompieri Neto.
...
\begin{resumoumacoluna}
	...
	\input{abstracts/resumo.tex}	% Adicionando o resumo
...
\begin{resumoumacoluna}[Abstract]
	...
	\input{abstracts/abstract.tex}	% Adicionando o resumo
	
		\vspace{\onelineskip}
	
	\noindent
	\textbf{Palavras-chaves}: economic, avaliação de impactos. \\	% Adicionando as palavras-chaves
	\textbf{JEL}: J45, C45, G45.	% Adicionando as palavras-chaves
...
Conforme Soyster \emph{et al.} (1973), Biderman (2001), Capobiango
\emph{et al.} (2012), da Silva Marioni \emph{et al.} (2016) e Oliveira
\emph{et al.} (2019).
...
BIDERMAN, C. DISTRIBUIÇÃO REGIONAL DO CRÉDITO BANCÁRIO E CONVERGÊNCIA NO
CRESCIMENTO ESTADUAL BRASILEIRO. 2001.

\leavevmode\hypertarget{ref-Capobiango2012}{}%
CAPOBIANGO, R. P. \emph{et al.} Análise do impacto econômico do crédito
rural na microrregião de pirapora. \textbf{Revista de Economia e
Sociologia Rural}, v. 50, n. 4, p. 631--644, 2012.

\leavevmode\hypertarget{ref-DaSilvaMarioni2016}{}%
DA SILVA MARIONI, L. \emph{et al.} Uma aplicação de regressão quantílica
para dados em painel do pib e do pronaf. \textbf{Revista de Economia e
Sociologia Rural}, v. 54, n. 2, p. 221--242, 2016.

\leavevmode\hypertarget{ref-Oliveira2019}{}%
OLIVEIRA, A. I. DE \emph{et al.} Os Benefícios da Utilização do Software
Open Source GRETL no Ensino em Econometria. \textbf{XIX Encontro de
Iniciação à Docência UNIFOR}, n. Id, p. 5, 2019.

\leavevmode\hypertarget{ref-Soyster1973a}{}%
SOYSTER, A. L. \emph{et al.} Impactos Regionais do Recente Processo de
Concentração Bancária no Brasil Adriana. \textbf{Bba}, v. 21, n. July,
p. 1154--1157, 1973.	% No próprio texto é necessário invocar \postextual
