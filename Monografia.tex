...
%
\documentclass[]{abntex2}	% Opções da classe do documento:
...
\titulo{Monografia}	% Adicionando o título
\autor{Alysson Oliveira}	% Adicionando autor(es)
\data{04/02/2020}	% Adicionando a data
...
\textual	% Início do texto convertido do arquivo original
	% No próprio texto é necessário invocar \postextual
